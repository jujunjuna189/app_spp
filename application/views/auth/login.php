                    ...
                    <div class="card-body px-5">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group flex-nowrap">
                                <input type="text" class="form-control border-0 border-top border-start border-bottom" placeholder="Isi username dengan benar" aria-label="Isi username dengan benar" aria-describedby="addon-wrapping">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group flex-nowrap">
                                <input type="text" class="form-control border-0 border-top border-start border-bottom" placeholder="Isi password dengan benar" aria-label="Isi password dengan benar" aria-describedby="addon-wrapping">
                                <span class="input-group-text bg-white border-0 border-top border-end border-bottom" id="addon-wrapping">
                        ...
                        <div class="form-group text-center mb-3">
                            <button type="submit" class="btn btn-primary fw-semibold px-3" onclick="window.open('<?= base_url('dashboard') ?>', '_blank')">
